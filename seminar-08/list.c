...
static
struct node *list_new_node(const struct list *list, const void *data)
{
...
static
void list_attach(struct list *list, struct node *node, struct node *prev)
{
    node->prev = prev;
...
static
struct node *list_detach(struct list *list, struct node *node)
{
